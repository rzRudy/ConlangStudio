        ...
        <div className="lg:col-span-2 bg-slate-800 border border-slate-700 rounded-xl p-6 shadow-md flex flex-col max-h-[400px]">
          ...
          <div className="space-y-1 overflow-y-auto custom-scrollbar flex-1">
            {recentEntries.length > 0 ? (
                ...
                <div key={entry.id} className="flex items-center justify-between p-3 hover:bg-slate-700/50 rounded-md transition-colors border-b border-slate-700/50 last:border-0 group">
